...
logo = ("""
 ...
 \033[1;91m\033[1;41m\033[1;97m           MR-IMRAN-60       \033[;0m\033[1;91m\033[1;92m
 \033[1;93m**************************************************
 \033[1;93m|     \033[1;96m[ðŸ”°] CREATED BY\33[0;m   :  \033[1;96mIMRAN               \033[1;93m|
 \033[1;93m|     \033[1;32m[ðŸ”°] FACEBOK      : \033[1;34m IMRAN AHMED     \033[1;93m|
 \033[1;93m|     \033[1;35m[ðŸ”°] GITHUB       :  \033[1;35mMR-IMRAN-60    \033[1;93m|
 \033[1;93m|     \033[1;36m[ðŸ”°] TOOL STATUS  : \033[1;36m RANDOM CLONING        \033[1;93m|
...
def fuck():
    ...
    print(' [✓] OK Ids saved as IMRAN-OK.txt')
    print(' [✓] CP Id Save as IMRAN-CP.txt')
    print('-------------------')
def hasan(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[IMRAN]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
